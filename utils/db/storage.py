...
class DatabaseManager(object):
    ...
    def create_tables(self):
        ...
        self.query('CREATE TABLE IF NOT EXISTS orders (cid int, usr_name text, usr_address text, products text, phone text)')
...
orders: cid int, usr_name text, usr_address text, products text, phone text
